...
void *handle_frontend(void *args) {
    ...
    ::vector<WorkerArgs> workers = {
        {"10.128.0.21", 8082, query, k, {}},
        {"10.128.0.22", 8082, query, k, {}},
        {"10.128.0.23", 8082, query, k, {}},
        {"10.128.0.25", 8082, query, k, {}},
        {"10.128.0.26", 8082, query, k, {}},
        {"10.128.0.27", 8082, query, k, {}},
        {"10.128.0.28", 8082, query, k, {}},
        {"10.128.0.29", 8082, query, k, {}}};
