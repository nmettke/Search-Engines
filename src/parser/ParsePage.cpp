...
enum class Options { PrintSimplePage, PrintWords, PrintTitleWords, PrintLinks, PrintBase };
...
void PrintParse(HtmlParser &parser) {
    ...
    case Options::PrintSimplePage:
        ...
        cout << "<body style=\"font-family:Verdana,Arial,Helvetica,sans-serif;font-size:10pt\">"
             << endl;

        cout << "<h2 style=\"font-family:Verdana,Arial,Helvetica,sans-serif;font-size:12pt; "
                "font-weight: bold\">"
             << endl
             << "Title" << endl
             << "</h2>" << endl;
        ...
        cout << "<p>" << endl
             << "<a href=\"" << parser.base << "\">" << parser.base << "</a>" << endl
             << "</p>" << endl
             << endl;
